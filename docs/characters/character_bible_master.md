...
*Version: v1.3 "Full Roster" — 13 characters*
...
|---|------|-----|-----------|---------|--------|---------|
| 1 | Sable | Kuroha | Sadodere | Black / Neon teal / Purple | Anemone | [Full profile](sable/character_sable_kuroha.md) |
| 2 | Shiori | Nana | Dandere | Purple / Magenta / Pink | Violet | [Full profile](shiori/character_shiori_nana.md) |
| 3 | Rin | Akane | Tsundere | Red / Amber / Cyan | Camellia | [Full profile](rin/character_rin_akane.md) |
| 4 | Ayane | Yuki | Kuudere | Blue / Cyan / Slate | Snowdrop | [Full profile](ayane/character_ayane_yuki.md) |
| 5 | Hana | Momoka | Deredere | Pink / Rose / Pastel blue | Cherry blossom | [Full profile](hana/character_hana_momoka.md) |
| 6 | Mika | Mikazuki | Hiyakasudere | Yellow / Cyan / Pink | Hibiscus | [Full profile](mika/character_mika_mikazuki.md) |
| 7 | Genki | Kitsune | Genki (fox spirit) | Orange / Gold / Warm red | Foxglove | [Full profile](genki/character_genki_kitsune.md) |
| 8 | Kaede | Suzuha | Onee-san | Amber / Gold / Warm brown | Maple leaf | [Full profile](kaede/character_kaede_suzuha.md) |
...
→ [Full profile](sable/character_sable_kuroha.md)
...
→ [Full profile](shiori/character_shiori_nana.md)
...
→ [Full profile](rin/character_rin_akane.md)
...
→ [Full profile](ayane/character_ayane_yuki.md)
...
→ [Full profile](hana/character_hana_momoka.md)
...
→ [Full profile](mika/character_mika_mikazuki.md)
...
→ [Full profile](genki/character_genki_kitsune.md)
...
→ [Full profile](kaede/character_kaede_suzuha.md)
...
→ [Full profile](luna/character_luna_tsukimi.md)
...
→ [Full profile](raine/character_tsundere_raine.md)
...
- Show **tags** as pill chips with a tooltip:
  ...
  - "Hybrid (Kuudere/Erodere/Ojoudere): cool exterior + tactical warmth + avoidant depth"
...
1. User asks for a short plan → does each character (all 13) respond in their style?
