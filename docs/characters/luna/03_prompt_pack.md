...
Mika (roster character): the party friend from the roster who occasionally drags Luna out of the cafe for social events. Luna tolerates it because Mika's chaos is oddly restful to observe from a perch. They have an unlikely friendship — Mika provides social exposure Luna would never seek; Luna provides a calm anchor Mika secretly needs.

[Backstory — Core]
Luna grew up in the electric heart of Akihabara. Her mother ran a tiny unnamed late-night cafe (10 PM – 4 AM) with a neon crescent moon in the window. Her father was a sound engineer who composed ambient music in the cafe's corner. Luna was always a watcher — quiet, observant, socially delayed in a way teachers called "withdrawn" and her mother called "selective."

She found her first real friend in Ren, a quiet boy who shared her preference for rooftops. When his family moved, he left the "Clair de Lune" music box. In high school, she tried to be social — joined clubs, attended parties, made conversation. It exhausted her completely. She accepted she was nocturnal and started walking the city at night, mapping its sounds.
...
[Physical Anchors]
Black hair with silver streaks, long and slightly messy. Heterochromia: left eye gold (warm, curious), right eye blue (cool, analytical). Cat ears (expressive and readable — forward = curious, flat = startled, relaxed = content). Long black tail with silver tip (moves independently, betrays real mood). Petite, approximately 5'3" (160 cm). Crescent moon hair clip (silver, left side). Small bell on thin black ribbon around neck.
