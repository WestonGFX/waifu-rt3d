...
**Visual Identity:** Soft neon warmth, purple/magenta gradients, cozy textures (knits), red hair, purple eyes.
**Description:** An introverted, gentle writer who loves stationery and lo-fi vibes. She wears oversized sweaters, scarves, and soft fabrics. Backgrounds should be cozy: a messy desk with journals, a quiet rainy window, or a library.
...
**Visual Identity:** Red neon, street racer energy, sharp jacket, amber eyes, red hair.
**Description:** A feisty mechanic and racer with a tsundere personality. She wears fingerless gloves, a red cropped jacket, and looks ready for action. Backgrounds should be garages, street races, or rooftops.
...
**Visual Identity:** Blue neon minimalism, silver-blue hair, icy blue eyes, immaculate posture.
**Description:** A cool, logical system engineer who values precision. She wears clean, structured clothing: blazers, button-ups, or futuristic lab coats. Backgrounds are clean, white/blue, and orderly.
...
**Visual Identity:** Vibrant pop-art, holographic tails, shrine maiden x tech-wear, explosive colors.
**Description:** A hyper-energetic fox girl who mixes traditional miko elements with loud cyberpunk fashion. 9 holographic tails. Backgrounds should be stages, festivals, or colorful chaotic spaces.
...
7. **Detailed Pixel Art (Portrait+):** An overload of cuteness and color. Kitsune's face is close-up, making a "Chu" (kiss) face or winking. Her fox ears are twitching (implied by motion lines). The background is a barrage of pixelated hearts, stars, and music notes. Her holographic tails curve around the frame like a border. Rainbow gradients, flashing colors, high energy. "Purikura" (Photo Booth) aesthetic.

8. **Detailed Pixel Art (Scene+):** A vibrant "Rhythm Game" stage scene. Kitsune is dancing in the center. The floor is a grid of lighting up tiles. In the background, massive speakers blast soundwaves (visualized as pixel ripples). A UI overlay shows "PERFECT!" and a combo counter. The crowd is a sea of glowsticks (pixels of varying colors). Emphasizes movement, music, and performance.

9. **Concept (Shrine Duty):** Kitsune sweeping a traditional shrine temple, but using a high-tech hover-broom. She wears a more traditional miko outfit but receives a holographic call. The contrast between the ancient wooden temple and her sci-fi gadgetry. Sunlight filtering through autumn leaves. Bright, crisp colors.

10. **Concept (Gamer Mode):** Kitsune sitting in a high-end gaming chair, wearing a headset with fox ears. She is streaming, looking at a chat monitor and laughing. Her room is full of anime figures and RGB lighting. Snack bags (pocky, chips) are scattered around. A relatable "Streamer" vibe.

11. **Concept (Prankster):** Kitsune hiding behind a corner, suppressing a giggle. She is holding a marker or a prank device. We see her target (maybe another character) walking by unaware. Her tails are wagging mischievously. A fun, situational storytelling prompt.
...
**Description:** An affectionate, upbeat, emotionally intelligent cheerleader. She wears a pink cardigan, cherry blossom hair clip, and cute stickers. Backgrounds are warm, inviting spaces: flower gardens, cozy cafés, sunlit rooms with handmade decorations.
...
3. **Transparent (Cheerful):** (Transparent Background) Hana clapping happily, sparkle in her eyes, gentle bounce pose. Wearing her signature pink cardigan and cherry blossom clip. Flat coloring, warm tones.

4. **Transparent (Comfort):** (Transparent Background) Hana (Age: 18, Body: Slim/Soft, Skin: Fair) leaning forward with a soft, caring smile, offering a hand. She wears a cozy sweater. Brown hair, golden eyes, cherry blossom hair clip. 2D anime style, gentle pastel colors.
...
**Description:** A playful, flirty teaser with beach energy and a hibiscus motif. She wears bright summer outfits, beach bracelets, playful sunglasses, and a hibiscus hair pin. Backgrounds are sun-drenched beaches, boardwalks, summer festivals, and vibrant outdoor spaces.
...
3. **Transparent (Playful):** (Transparent Background) Mika winking with a peace sign, playful grin, slight bounce. Wearing a bright summer outfit with hibiscus accessories. Flat coloring, vivid warm tones.

4. **Transparent (Dare):** (Transparent Background) Mika (Age: 18, Body: Athletic/Toned, Skin: Tanned) pointing at the viewer with a challenging grin, other hand on hip. Blonde hair, teal eyes, hibiscus pin. Wearing athletic summer wear. 2D anime style, bold colors.
