        ...
        <div style={cardStyle} className="px-4">
          ...
          <div style={{ opacity: showQuickChips ? 1 : 0.5, pointerEvents: showQuickChips ? 'auto' : 'none' }}>
            ...
            >
              ...
              >
                {([2, 3] as const).map(n => {
                  const current = cfg('reply_pills_count', 3) === 2 ? 2 : 3;
                  return (
                    <button
                      key={n}
                      ...
                      className="px-3 py-1 rounded-md text-xs font-medium transition-all"
                      style={{
                        backgroundColor: current === n ? 'var(--color-accent)' : 'transparent',
                        color: current === n ? 'var(--color-accent-text)' : 'var(--color-text-muted)',
                      }}
                    >
                      {n}
                    </button>
            ...
            >
              ...
              >
                {([
                  ...
                  const current = cfg('reply_pills_action', 'fill') === 'send' ? 'send' : 'fill';
                  return (
                    <button
                      key={opt.id}
                      ...
                      className="px-3 py-1 rounded-md text-xs font-medium transition-all"
                      style={{
                        backgroundColor: current === opt.id ? 'var(--color-accent)' : 'transparent',
                        color: current === opt.id ? 'var(--color-accent-text)' : 'var(--color-text-muted)',
                      }}
                    >
                      {opt.label}
                    </button>
